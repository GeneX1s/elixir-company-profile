...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="/dashboard">Pawon Bule</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>Pawon Bule</span></h1>
          <h2>"Bringing flavor to your doorstep, one dish at a time."</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src={{$menu->foto}} class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">{{$menu->nama}}</a><span>Rp.{{ number_format($menu->harga, '2', ',', '.') }}</span>
            </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-{{$key}}">{{$special->title}}</a>
              </li>

              @endforeach

              {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-1">Modi sit est</a>
              </li>
              <li class="nav-item">
              ...
              <div class="tab-pane" id="tab-{{$key}}">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>{{$special->header_1}}</h3>
                    <p class="fst-italic">{{$special->header_2}}</p>
                    <p>{{$special->desc}}</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src={{$special->foto}} alt="" class="img-fluid">
                  </div>
                </div>
              </div>
