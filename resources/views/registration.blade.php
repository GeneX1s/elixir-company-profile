<!DOCTYPE html>
<html lang="en-US">
<!-- Mirrored from prium.github.io/elixir/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 04:20:58 GMT -->
<!-- Added by HTTrack -->
              ...
              <form class="mt-4 text-left" method="post">
                <div class="row align-items-center">
                  <div class="col-6"><input class="form-control" type="hidden" name="to"
                      value="username@domain.extension"><input class="form-control" type="text" placeholder="First name"
                      aria-label="Text input with dropdown button"></div>
                  <div class="col-6"><input class="form-control" type="text" placeholder="Last name"
                      aria-label="Text input with dropdown button"></div>
                  <div class="col-12 mt-4"><input class="form-control" type="email" placeholder="Email Address"
                      aria-label="Text input with dropdown button">
                  </div>
                  <div class="col-12 mt-4"><input class="form-control" type="Password" placeholder="Password"
                      aria-label="Text input with dropdown button"></div>
                  <div class="col-12 mt-4"><input class="form-control" type="Password" placeholder="Confirm Password"
                      aria-label="Text input with dropdown button">
                  </div>
                </div>
                <div class="row align-items-center mt-3">
                  <div class="col-md-6 mt-3"><label class="form-check-label"><input class="form-check-input"
                        type="checkbox"><span class="color-7">I agree
                        with the terms &amp; conditions</span></label></div>
                  <div class="col-md-6 mt-3"><button class="btn btn-primary btn-block" type="submit">Create
                      Account</button></div>
                </div>
              </form>
            </div>
...
<!-- Mirrored from prium.github.io/elixir/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 04:21:00 GMT -->
